...
ENTITY counter_8bits IS
    ...
    PORT (
        ...
        tick_1s        :  IN STD_LOGIC; -- απο divider   
...
ARCHITECTURE rtl OF counter_8bits IS
    ...
    SIGNAL start_stop_low  : STD_LOGIC;
    SIGNAL start_stop_high : STD_LOGIC;

    BEGIN

        -- enable για low nibble
        start_stop_low  <= start_stop and tick_1s;
        ...
        start_stop_high <= ((start_stop AND tick_1s) AND (cnt_low(3) AND cnt_low(2) AND cnt_low(1) AND cnt_low(0)));
